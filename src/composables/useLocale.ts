...
const messages = {
  'zh-Hans': {
    ...
    renderingDocument: '正在渲染文档…', welcomeTitle: '把 Markdown 读成文档', welcomeDescription: '打开本地文件，专注于内容。远程资源默认保持阻断。', welcomeHint: '支持 .md / .markdown / .txt · 也可以将文件拖入窗口', dropToOpen: '释放以打开 Markdown 文件',
    ...
    openDocuments: '打开的文档', switchTo: '切换到 {name}', documentHasError: '此文档有错误', needsAttention: '需检查', closeDocument: '关闭文档', documentTabActions: '文档标签操作', close: '关闭', closeOthers: '关闭其他', closeLeft: '关闭左侧', closeRight: '关闭右侧', closeAll: '关闭全部',
  ...
  en: {
    ...
    renderingDocument: 'Rendering document…', welcomeTitle: 'Read Markdown as a document', welcomeDescription: 'Open a local file and focus on its content. Remote resources stay blocked by default.', welcomeHint: 'Supports .md / .markdown / .txt · You can also drop a file into this window', dropToOpen: 'Drop to open a Markdown file',
    ...
    openDocuments: 'Open documents', switchTo: 'Switch to {name}', documentHasError: 'This document has an error', needsAttention: 'Needs attention', closeDocument: 'Close document', documentTabActions: 'Document tab actions', close: 'Close', closeOthers: 'Close others', closeLeft: 'Close tabs to the left', closeRight: 'Close tabs to the right', closeAll: 'Close all',
  ...
  'zh-Hant': {
    ...
    renderingDocument: '正在轉譯文件…', welcomeTitle: '把 Markdown 讀成文件', welcomeDescription: '開啟本機檔案，專注於內容。遠端資源預設保持封鎖。', welcomeHint: '支援 .md / .markdown / .txt · 也可以將檔案拖入視窗', dropToOpen: '放開以開啟 Markdown 檔案',
    ...
    openDocuments: '已開啟的文件', switchTo: '切換至 {name}', documentHasError: '此文件有錯誤', needsAttention: '需檢查', closeDocument: '關閉文件', documentTabActions: '文件分頁動作', close: '關閉', closeOthers: '關閉其他', closeLeft: '關閉左側', closeRight: '關閉右側', closeAll: '關閉全部',
  ...
  ja: {
    ...
    renderingDocument: '文書を描画中…', welcomeTitle: 'Markdown を文書として読む', welcomeDescription: 'ローカルファイルを開いて内容に集中できます。リモートリソースは既定でブロックされます。', welcomeHint: '.md / .markdown / .txt に対応 · ファイルをウィンドウにドロップすることもできます', dropToOpen: 'ドロップして Markdown ファイルを開く',
    ...
    openDocuments: '開いている文書', switchTo: '{name} に切り替える', documentHasError: 'この文書にはエラーがあります', needsAttention: '要確認', closeDocument: '文書を閉じる', documentTabActions: '文書タブの操作', close: '閉じる', closeOthers: '他を閉じる', closeLeft: '左側を閉じる', closeRight: '右側を閉じる', closeAll: 'すべて閉じる',
